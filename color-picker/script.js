...
function getRandomNumber() {
    return Math.floor(Math.random() * COLORLIMIT);
}
...
function generateColor() {
    let displaycolorElement = document.getElementById("displaycolor");
    let colornameElement = document.getElementById("colorname");
    let hexnameElement = document.getElementById("hexname");

    let randomNumber = getRandomNumber();
    let color = getColor(randomNumber);

    // Setting up the background color
    setBackgroundColor(displaycolorElement, color.hex);

    // Display the color name
    displayText(colornameElement, "Color: " + color.name);

    // Display the hex value
    displayText(hexnameElement, "Hex: " + color.hex);
